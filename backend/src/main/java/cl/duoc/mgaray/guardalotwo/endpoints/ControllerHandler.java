...
import cl.duoc.mgaray.guardalotwo.endpoints.response.BaseResponse;
import cl.duoc.mgaray.guardalotwo.endpoints.response.MessageResponse;
...
public class ControllerHandler {
  ...
  public ResponseEntity<BaseResponse> exception(Exception exception) {
    ...
    var message = String.format(COMMON_EXCEPTION_MESSAGE, "support@guardalotwo.cl");
